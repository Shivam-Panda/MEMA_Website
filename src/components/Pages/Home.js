    ...
    return (
        <div className="Home">
            <div className='Project'>
                ...
                <p>
                    Have you ever felt unsure about your future career path? We understand the challenges of making such decisions at a young age, and with MEMA, we aim to provide students with the exposure and experiences needed to make informed choices and pursue their passions with confidence. MEMA aims to revolutionize the learning experience, offering more than just textbooks and lectures. Through dynamic workshops, immersive field trips, and hands-on educational kits, students will unravel the mysteries of dynamic fields, gaining invaluable insights. Guided by dedicated mentors and offered engineering and medical shadowing opportunities, students will not only grasp the significance of classroom lessons but also see themselves as future engineers and healthcare professionals. 
                </p>
            </div>
